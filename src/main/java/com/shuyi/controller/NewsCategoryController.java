...
public class NewsCategoryController {
	...
	public String newsCategoryManage(NewsCategory newsCategory,@PathVariable Integer pageCurrent,@PathVariable Integer pageSize,@PathVariable Integer pageCount, Model model,HttpSession httpSession) {
		//判断
	...
	public String newsCategoryEditGet(Model model,NewsCategory newsCategory,HttpSession httpSession) {
